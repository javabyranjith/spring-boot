...
public class ProductDao {
	...
	public void addProduct() {
		...
		jdbcTemplate.execute(
				"CREATE TABLE product (id VARCHAR(30), name VARCHAR(20), type VARCHAR(30), price VARCHAR(30))");
	...
	public List<Product> getAllProducts() {
		...
		jdbcTemplate.query("SELECT * FROM product", new Object[] {}, (rs, row) -> new Product(rs.getString("id"),
				rs.getString("name"), rs.getString("type"), rs.getString("price"))).forEach(products::add);
